...
namespace DocServiceCore.Helpers
{
    ...
    // Adapted from https://msdn.microsoft.com/en-us/library/office/cc850838.aspx
    public static class DocHelper
    {
        ...
        {
            styleid = (string.IsNullOrWhiteSpace(styleid) || styleid.ToLowerInvariant() == "unknown".ToLowerInvariant()) ? styleid : Guid.NewGuid().ToString();
        ...
        public static void AddStyles(MainDocumentPart part)
        {
        ...
        #region Generated by the OpenXML SDK document Reflector
