...
namespace DocServiceCore.Helpers
{
    ...
    public static class DocCreator
    {
        ...
        public static void CreatePackage(Stream stream, FullDoc doc)
        {
            using (WordprocessingDocument package = WordprocessingDocument.Create(stream, WordprocessingDocumentType.Document))
            {
                CreateParts(package, doc);
            }
        }

        // Adds child parts and generates content of the specified part.
        private static void CreateParts(WordprocessingDocument document, FullDoc doc)
        {
            ExtendedFilePropertiesPart extendedFilePropertiesPart1 = document.AddNewPart<ExtendedFilePropertiesPart>("rId3");
            GenerateExtendedFilePropertiesPart1Content(extendedFilePropertiesPart1);

            MainDocumentPart mainDocumentPart1 = document.AddMainDocumentPart();
            GenerateMainDocumentPart1Content(mainDocumentPart1, doc);
        ...
        private static void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
        {
            ...
            charactersWithSpaces1.Text = "114";
        ...
        private static void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1, FullDoc doc)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "004665FF", RsidParagraphProperties = "001C1285", RsidRunAdditionDefault = "001C1285" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "001C1285", RsidParagraphProperties = "001C1285", RsidRunAdditionDefault = "001C1285" };

            ParagraphProperties paragraphProperties2 = new ParagraphProperties();
            ParagraphStyleId paragraphStyleId2 = new ParagraphStyleId() { Val = "Subtitle" };

            paragraphProperties2.Append(paragraphStyleId2);

            Run run2 = new Run();
            Text text2 = new Text();
            text2.Text = $"Created {doc.Header.Created} (UTC)";
            ...
            TableStyle tableStyle1 = new TableStyle() { Val = "TableGridLight" };
            ...
            GridColumn gridColumn1 = new GridColumn() { Width = "1696" };
            GridColumn gridColumn2 = new GridColumn() { Width = "7320" };
            ...
            foreach (var para in doc.Paragraphs)
            {
                ...
                TableCellWidth tableCellWidth1 = new TableCellWidth() { Width = "1696", Type = TableWidthUnitValues.Dxa };
                ...
                TableCellWidth tableCellWidth2 = new TableCellWidth() { Width = "7320", Type = TableWidthUnitValues.Dxa };
            ...
            //TableRow tableRow2 = new TableRow() { RsidTableRowAddition = "001C1285", RsidTableRowProperties = "001C1285" };

            //TableCell tableCell3 = new TableCell();

            //TableCellProperties tableCellProperties3 = new TableCellProperties();
            //TableCellWidth tableCellWidth3 = new TableCellWidth() { Width = "1696", Type = TableWidthUnitValues.Dxa };

            //tableCellProperties3.Append(tableCellWidth3);

            //Paragraph paragraph5 = new Paragraph() { RsidParagraphAddition = "001C1285", RsidParagraphProperties = "001C1285", RsidRunAdditionDefault = "001C1285" };

            //Run run6 = new Run();
            //Text text6 = new Text();
            //text6.Text = "Timestamp 2";
            ...
            //TableCellWidth tableCellWidth4 = new TableCellWidth() { Width = "7320", Type = TableWidthUnitValues.Dxa };

            //tableCellProperties4.Append(tableCellWidth4);

            //Paragraph paragraph6 = new Paragraph() { RsidParagraphAddition = "001C1285", RsidParagraphProperties = "001C1285", RsidRunAdditionDefault = "001C1285" };

            //Run run7 = new Run();
            //Text text7 = new Text();
            //text7.Text = "Paragraph 2";
            ...
            Paragraph paragraph7 = new Paragraph() { RsidParagraphMarkRevision = "001C1285", RsidParagraphAddition = "001C1285", RsidParagraphProperties = "001C1285", RsidRunAdditionDefault = "001C1285" };

            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "001C1285", RsidR = "001C1285" };
        ...
        private static void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "001C1285" };
            Rsid rsid1 = new Rsid() { Val = "001C1285" };
            Rsid rsid2 = new Rsid() { Val = "004665FF" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "268CD15A" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{357DD855-FAA9-4504-BF1A-58571609CB5E}" };
        ...
        private static void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            Languages languages1 = new Languages() { Val = "en-AU", EastAsia = "en-US", Bidi = "ar-SA" };
            ...
            Rsid rsid3 = new Rsid() { Val = "001C1285" };
            ...
            FontSize fontSize2 = new FontSize() { Val = "56" };
            ...
            Rsid rsid4 = new Rsid() { Val = "001C1285" };
            ...
            Style style7 = new Style() { Type = StyleValues.Paragraph, StyleId = "Subtitle" };
            StyleName styleName7 = new StyleName() { Val = "Subtitle" };
            BasedOn basedOn3 = new BasedOn() { Val = "Normal" };
            NextParagraphStyle nextParagraphStyle2 = new NextParagraphStyle() { Val = "Normal" };
            LinkedStyle linkedStyle3 = new LinkedStyle() { Val = "SubtitleChar" };
            UIPriority uIPriority6 = new UIPriority() { Val = 11 };
            PrimaryStyle primaryStyle3 = new PrimaryStyle();
            Rsid rsid5 = new Rsid() { Val = "001C1285" };
            ...
            Color color1 = new Color() { Val = "5A5A5A", ThemeColor = ThemeColorValues.Text1, ThemeTint = "A5" };
            Spacing spacing3 = new Spacing() { Val = 15 };

            styleRunProperties3.Append(runFonts4);
            styleRunProperties3.Append(color1);
            styleRunProperties3.Append(spacing3);
            ...
            Style style8 = new Style() { Type = StyleValues.Character, StyleId = "SubtitleChar", CustomStyle = true };
            StyleName styleName8 = new StyleName() { Val = "Subtitle Char" };
            BasedOn basedOn4 = new BasedOn() { Val = "DefaultParagraphFont" };
            LinkedStyle linkedStyle4 = new LinkedStyle() { Val = "Subtitle" };
            UIPriority uIPriority7 = new UIPriority() { Val = 11 };
            Rsid rsid6 = new Rsid() { Val = "001C1285" };
            ...
            styleRunProperties4.Append(spacing4);
            ...
            Style style9 = new Style() { Type = StyleValues.Table, StyleId = "TableGrid" };
            StyleName styleName9 = new StyleName() { Val = "Table Grid" };
            BasedOn basedOn5 = new BasedOn() { Val = "TableNormal" };
            UIPriority uIPriority8 = new UIPriority() { Val = 39 };
            Rsid rsid7 = new Rsid() { Val = "001C1285" };
            ...
            Style style10 = new Style() { Type = StyleValues.Table, StyleId = "TableGridLight" };
            StyleName styleName10 = new StyleName() { Val = "Grid Table Light" };
            BasedOn basedOn6 = new BasedOn() { Val = "TableNormal" };
            UIPriority uIPriority9 = new UIPriority() { Val = 40 };
            Rsid rsid8 = new Rsid() { Val = "001C1285" };
        ...
        {
            document.PackageProperties.Creator = "Auto-generated by Transcript Creator";
